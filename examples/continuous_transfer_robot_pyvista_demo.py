...
def show_continuous_transfer_robot_demo(
    *,
    ...
    # Framebuffer/color-attachment warnings are VTK/OpenGL render warnings
    # caused by features like multisampling/depth buffers, not planner failures.
...
def main() -> None:
    ...
    if args.cspace_exact_surfaces_alias is True:
        ...
        print("Deprecated approximate C-space surface flag ignored; exact truth-only mode is active.", flush=True)
        args.cspace_surface_mode = "exact"
